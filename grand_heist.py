...
def crack_passcode(data_sequence):
    ...
    while our_list[i] <= sqrtn :
        
        no = integers[i]

        for j in range(ub-1, i, -1):
            if j % no == 0:
                integers.remove(j)
...
if __name__ == "__main__":
    ...
    # 1. Ask user for key color and parse it into a tuple
    raw_color = input("Enter the security key color (R,G,B): ")
    # TODO: Parse raw_color into a tuple of integers
    
    # 2. Phase 1 Setup & Execution
    # TODO: Create a world with scattered beepers, create Hubo, call infiltrate_vault
    
    # 3. Phase 2 Setup & Execution
    # TODO: Load a test image, call decrypt_feed, show() the result
    
    # 4. Phase 3 Setup & Execution
    test_sequence = [14, "tcejorp", (1, 2), 7, 23, "looc", 8, 97, "101SC"]
    # TODO: Call crack_passcode
    
    # 5. Phase 4 Execution
    # TODO: Pass outputs from Phase 3 into draw_blueprint
